...
const getLinkedPatients = (fhirResource) => {
    const linkedPrincipals = patientCompartment.getLinkedPrincipals(fhirResource)
...
performFGASingleResourceCheck = async (fgaClient, authorizationContext, fhirObject, action) => {
    ...
    const linkedPatients = getLinkedPatients(fhirObject)
